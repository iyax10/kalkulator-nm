#memanggil library/modul Tkinter (GUI)
from tkinter import*
import tkinter.font as font
import math #penyedia fungsi untuk operasi matematika




root = Tk()  #membuat jendela GUI
...
e = Entry(root,width=25,borderwidth=0) #widget Entry=untuk membuat kolom inputan
e["font"]= myfont
e["bg"] = "white"
...
ak2 = Button(root,text="√",padx = 25,bg="#878787",fg="black", pady = 20,command=akar)
...
equal = Button(root,text="=",padx = 60,bg="#f57002", pady = 20,command=samadengan)
